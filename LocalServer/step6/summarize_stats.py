...
class StatsAnalyzer:
    def __init__(self, api_key):
        ...
        self.summary_file = f"LocalServer/step6/{match_id}_player_summaries.json"
...
def main():
    try:
        # Load data
        print("Loading data...")
        with open(f'LocalServer/step5/{match_id}_playerStats.json', 'r') as f:
            player_stats = json.load(f)
        
        with open('LocalServer/step5/transformedData.json', 'r') as f:
            data = json.load(f)
