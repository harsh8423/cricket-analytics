...
def main():
    try:
        ...
        player_data = load_json_file(f'LocalServer/step3/{match_id}_playerWiseData.json')
        
        print("Loading processed data...")
        processed_data = load_js_file(f'LocalServer/step3/{match_id}_processedData.js')
        ...
        save_json_file(final_data, 'LocalServer/step5/transformedData.json')
